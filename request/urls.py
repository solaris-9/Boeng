...
urlpatterns = [
    ...
    path('request/gpi/user/delete', user_views.delete),
    ...
    path('request/gpi/allocate/country_list', common.country_list),
    path('request/gpi/allocate/hosting_list', common.hosting_list),
