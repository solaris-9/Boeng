...
from allocate import grade as gr
...
urlpatterns = [
    ...
    path('request/gpi/allocate/new_boeng_fetch', bv.new_boeng_fetch),
    ...
    path('request/gpi/allocate/grade_fetch', gr.grade_fetch),
    path('request/gpi/allocate/grade_edit', gr.grade_edit),
]
